<div class="docbox">
    ...
    <h3>5. Ihre Pflichten als Nutzer</h3>
    ...
    <h3>7. Verfügbarkeit der Leistungen</h3>
    ...
    <ul>
        <li>das Einstellen, die Verbreitung, das Angebot und die Bewerbung pornografischer, gegen Jugendschutzgesetze, gegen Datenschutzrecht und/oder gegen sonstiges Recht verstoßender und/oder betrügerischer Inhalte, Dienste und/oder Produkte;</li>
        <li>die Veröffentlichung oder Zugänglichmachung von Inhalten, durch die andere Teilnehmer oder Dritte beleidigt oder verleumdet werden;</li>
        <li>die Nutzung, das Bereitstellen und das Verbreiten von Inhalten, Diensten und/oder Produkten, die gesetzlich geschützt oder mit Rechten Dritter (z.B. Urheberrechte) belastet sind, ohne hierzu ausdrücklich berechtigt zu sein;</li>
        <li>die öffentliche Zugänglichmachung von urheberrechtlich geschützten Werken oder sonstige urheberrechtswidrige Handlungen, insbesondere bei der Nutzung von sog. „Internet-Tauschbörsen“ oder File-Sharing-Diensten.</li>
    </ul>
    ...
    <ul>
        <li>die Übertragung überdurchschnittlich großer Datenmengen und insbesondere die anhaltende Übertragung solcher Datenmengen;</li>
        <li>das Hosting eines Web-Servers oder anderer Server durch Nutzung eines Hotspots des Diensteanbieters;</li>
        <li>die Änderung der vorgegebenen DNS-Server in den Netzwerkeinstellungen des Hotspots des Diensteanbieters;</li>
        ...
        <li>die Verbreitung anzüglicher, anstößiger, sexuell geprägter, obszöner oder diffamierender Inhalte bzw. Kommunikation sowie solcher Inhalte bzw. Kommunikation die geeignet sind/ist, Rassismus, Fanatismus, Hass, körperliche Gewalt oder rechtswidrige Handlungen zu fördern bzw. zu unterstützen (jeweils explizit oder implizit);</li>
        <li>die Aufforderung anderer Nutzer oder Dritter zur Preisgabe von Kennwörtern oder personenbezogener Daten für kommerzielle oder rechts- bzw. gesetzeswidrige Zwecke.</li>
    </ul>
    ...
    <p>(1) Wir tragen Sorge dafür, dass Ihre personenbezogenen Daten nur erhoben, gespeichert und verarbeitet werden, soweit dies zur vertragsgemäßen Leistungserbringung erforderlich und durch gesetzliche Vorschriften erlaubt, oder vom Gesetzgeber angeordnet ist.</p>
    ...
    <p>(3) Um die Leistungen des Hotspots für Sie zu erbringen, ist die Verwendung von personenbezogenen Daten Ihres Endgerätes erforderlich. In dem Zusammenhang werden ggf. auch die MAC-Adressen von Endgeräten gespeichert. Ferner werden wir ggf. Protokolldaten („Logfiles“) über Art und Umfang der Nutzung der Dienstleistungen speichern. Diese Daten können nicht unmittelbar Ihrer Person zugeordnet werden.</p>
